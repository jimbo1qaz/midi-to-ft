...
# Originally by Peter Billam
# Modified by jimbo1qaz to accept "invalid" sysex events.
    ...
    while(len(trackdata)):
        ...
        if (first_byte < 0xF0):  # It's a MIDI event
            ...
            # Now the sticky events -------------------------------------
                 ...
                 E = ['sequencer_specific',time,trackdata[0:length].decode('ascii','ignore')]
            else:
                 E = ['raw_meta_event', time, command,
                       trackdata[0:length].decode('ascii','ignore')]
